...
export declare class RelativeUrlRebasingImporter extends UrlRebasingImporter {
    ...
    constructor(entryDirectory: string, directoryCache?: Map<string, DirectoryEntry>);
...
export declare class ModuleUrlRebasingImporter extends RelativeUrlRebasingImporter {
    private finder;
    constructor(entryDirectory: string, directoryCache: Map<string, DirectoryEntry>, finder: (specifier: string, options: CanonicalizeContext) => URL | null);
...
export declare class LoadPathsUrlRebasingImporter extends RelativeUrlRebasingImporter {
    private loadPaths;
    constructor(entryDirectory: string, directoryCache: Map<string, DirectoryEntry>, loadPaths: Iterable<string>);
    canonicalize(url: string, options: {
        fromImport: boolean;
    }): URL | null;
}
